...
public class UberPowderTier1 extends Item implements IHasModel {

	public UberPowderTier1(String name) {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
		...
		if (!worldIn.isRemote) {
			EntityUberPowder entityuberpowder = new EntityUberPowder(worldIn, playerIn);
