...
public class EntityUberPowder extends EntityThrowable {


	public EntityUberPowder(World worldIn) {
		super(worldIn);

	}

	public EntityUberPowder(World worldIn, EntityLivingBase throwerIn) {
		super(worldIn, throwerIn);
	}

	@SideOnly(Side.CLIENT)
	public EntityUberPowder(World worldIn, double x, double y, double z) {
		super(worldIn, x, y, z);
	}
