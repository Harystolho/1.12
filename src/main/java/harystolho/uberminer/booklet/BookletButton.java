...
public class BookletButton extends GuiButton{
	...
	public BookletButton(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText) {
	...
	public void drawButton(Minecraft mc, int mouseX, int mouseY, float partialTicks)
    {
        if (this.visible)
        {
            ...
            mc.getTextureManager().bindTexture(BookletGUI.RES_BUTTONS);
